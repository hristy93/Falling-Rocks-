...
void Draw()
{
	ClearScreen(consoleHandle);
	/*
	//Checking if a rock have hit the dwarf.
	if (!Collision)
	{
...
int main()
{
	...
	*/
	...
	//  Dwarf shape 3
	/*
	dwarf.push_back(GameObject(dwarfX - 1, dwarfY - 1, static_cast<char>(179)));
	dwarf.push_back(GameObject(dwarfX + 1, dwarfY - 1, static_cast<char>(179)));
	dwarf.push_back(GameObject(dwarfX - 1, dwarfY, static_cast<char>(207)));
	dwarf.push_back(GameObject(dwarfX + 1, dwarfY, static_cast<char>(207)));
	dwarf.push_back(GameObject(dwarfX, dwarfY - 2, static_cast<char>(178)));
	dwarf.push_back(GameObject(dwarfX - 1, dwarfY - 3, static_cast<char>(191)));
	dwarf.push_back(GameObject(dwarfX + 1, dwarfY - 3, static_cast<char>(218)));
	dwarf.push_back(GameObject(dwarfX, dwarfY - 3, static_cast<char>(254)));
	dwarf.push_back(GameObject(dwarfX, dwarfY - 4, static_cast<char>(79)));
	*/
